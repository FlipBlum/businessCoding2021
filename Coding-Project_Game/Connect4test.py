#define the board with 7 colons and 6 rows and instanciate the board
#basically creates a list of 6 lists that each contain 7 items
class Connect4:

    def __init__(self):
        self.numberOfColons = 7
        self.numberOfRows = 6
        self.board = [ [ '  ' for _ in range(self.numberOfColumns)] for _ in range(self.numberOfLines) ]

    #similar to our tic tac toe game this prints the board
...
#reutrns true or false depending on wether the slot is available for playing
